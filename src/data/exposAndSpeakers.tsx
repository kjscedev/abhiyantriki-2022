export const exposAndSpeakersDataJson = [
  {
    ...
    buttonHref: "http://bit.ly/Abhiyantriki_2022_Registration",
    buttonText: "Register",
    cards: [
      {
        heading: "Indro 5.0",
        text: "Meet the anticipated humanoid robot 'Indro 5.0', equipped with a day night vision camera with motion sensors. Created by Santosh Hulawale, this robot can maneuver on flat surface indoors and outdoors. It can also pick objects just like a human would. Get a chance to meet and interact with Indro 5.0, in person, at the Tech Expo during Abhiyantriki 2022.",
        image: `${process.env.PUBLIC_URL}/assets/expos/tech/AVISHKAR_HYPERLOOP.png`,
        cardHref: "#",
      },
      {
        heading: "Indian Army",
        text: "We, the Abhiyantriki 2022 organising team, are incredibly honoured and humbled to be working with the one and only The Indian Army this year. At the tech expo this year, The Indian Army will mainly be showcasing their infantry unit with weapons such as assault rifles, automatic guns, bombers, missiles, rocket launchers and much more! Seeing these weapons up close and in person will surely leave you awestruck and speechless.",
        image: `${process.env.PUBLIC_URL}/assets/expos/tech/RIVERRECYCLE OY.png`,
        cardHref: "#",
      },
      {
        heading: "BDDS",
        text: "The Bomb Detection and Disposal Squad has honored us with their presence in Abhiyantrik 2022! These brave men and women train meticulously and put it all on the line to diffuse and safely dispose of the explosive devices that threaten us.",
