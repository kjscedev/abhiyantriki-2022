    ...
    <footer className="site-footer mt-3">
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4">
          ...
          <div className="col p-2 footer-container">
            ...
            <ul className="list-unstyled">
              ...
              <li className="">
                <a
                  className="a-cancel highlight-on-hover"
                  href="tel:+91-810-413-5588"
                >
                  <span className="fw-bold">Dheemanta: </span>
                  +91 81041 35588
                </a>
              </li>
              <li className="link-heading-li">
          ...
          <div className="col p-2 footer-container">
            ...
            <div className="contact-links">
              ...
              <a
                href="http://bit.ly/Abhiyantriki_2022_Registration"
      ...
      >
        ...
        <div>
          Developed By
          <a
            href="https://www.linkedin.com/in/bevatsal1122/"
            target="_blank"
            className="dev-name"
          >
            {" "}
          ...
          <span>,</span>
          <a
            href="https://www.linkedin.com/in/arya-nair-2003/"
            target="_blank"
            className="dev-name"
          >
            {" "}
